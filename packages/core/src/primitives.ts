/**
 * All 36 CROSS+WALKRI primitives from the Primitives Foundation v0.1.4.
 *
...
export const PRIMITIVES: readonly CrossPrimitive[] = [
  ...
  },
  {
    ...
    layer: 'identity',
    description:
      'The declared capacity of the applying entity to continue operating in its stated form if the primary contributor or key personnel become unavailable. Three states: single, partial, and resilient.',
    relationships: [
  ...
  },
  {
    ...
    layer: 'evidence',
    description:
      'A gate element requiring that the people or communities served by a funded program participate in verifying what was delivered, not merely that independent third parties confirm delivery. Three configuration elements: beneficiary population, participation mechanism, and minimum participation threshold.',
    relationships: [
